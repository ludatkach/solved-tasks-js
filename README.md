...
```
[Elevator Distance](https://www.codewars.com/kata/59f061773e532d0c87000d16/train/javascript)
```javascript
...
```
[get ascii value of character](https://www.codewars.com/kata/55acfc59c3c23d230f00006d/train/javascript)
```javascript
function getASCII(c){
...
```
[UEFA EURO 2016](https://www.codewars.com/kata/57613fb1033d766171000d60/train/javascript)
```javascript
...
```
[Exclamation marks series #4: Remove all exclamation marks from sentence but ensure a exclamation mark at the end of string](https://www.codewars.com/kata/57faf12b21c84b5ba30001b0/train/javascript)
```javascript
function remove(s){
  return s.replace(/!/g, '') + '!';
